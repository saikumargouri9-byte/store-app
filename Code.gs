function doGet(e) {
  ...
  if (action === 'getDashboardData') {
    ...
    const tabs = [
      { name: 'ReceivingExceptions', dateCol: 'StockReceivingDate', storeCol: 'SiteCode', lpaCol: '', catCol: '', valCol: 'TotalValue' },
...
function createSheetWithHeaders(ss, sheetName) {
  const headersMap = {
    ...
    'ReceivingExceptions': ['Timestamp','SubmittedBy','StockReceivingDate','SendingDCCode','SiteCode','TripNo','TripDate','VehicleNo','STNNo','DeliveryNo','HUNo','ArticleCode','EnaCode','ArticleDescription','MapPerPiece','HuQty','ReceivedQty','Excess','ExcessVal','Short','ShortVal','Damaged','DamageVal','NearExpired','NearExpiryVal','Expired','NoOfDiscrepantEaches','TotalValue','Remarks'],
    ...
    'RegisterValidation':  ['Timestamp','SubmittedBy','StoreCode','Date','BusinessType','RegisterName','CheckingLpaName','ArticleCode','EanCode','ArticleDescription','MapPerPiece','RegisterQty','DocumentQuantity','ExceptionQty','ExceptionValue','OthersRemarks'],
    ...
    'IncidentLogs':        ['Timestamp','SubmittedBy','StoreCode','Date','LpaName','ExceptionType','EmpName','EmpID','BilledNo','RposID','CustomerName','CustomerGender','LocationFound','EanCode','ArticleCode','ArticleDescription','Quantity','MapPerPiece','TotalValue']
  };
